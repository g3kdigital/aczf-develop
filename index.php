...
<section class="banner">
    <div class="grupo-video">
      <video class="video-background" loop muted preload autoplay poster="img/video-cover-aircarrier.jpg">
        ...
        <source src="<?php the_field('video_url_ogv'); ?>" type="video/ogg">
       Tu navegador no soporta HTML5 Video  
      </video>
      <h3 class="titulo video">
        <?php the_field('titulo_banner_video'); ?>
...
=================================-->  
    <section class="seccion servicios">
      <h2 class="titulo principal">
      	<p><?php the_field('inicio_titulo_principal'); ?></p>
      </h2>    
      ...
      <article class="servicio comercio">
        ...
        <h4 class="titulo">
    		<?php the_field('seccion_servicio01'); ?>        	
        </h4>
      ...
      --><article class="servicio logistica">
        ...
        <h4 class="titulo">  
        	<?php the_field('seccion_servicio02'); ?>  
        </h4>        
      ...
      --><article class="servicio zonafranca">
        ...
        <h4 class="titulo">
        	<?php the_field('seccion_servicio03'); ?>  
        </h4>
      ...
      --><article class="servicio proyectos">
        ...
        <h4 class="titulo">        	
        	<?php the_field('seccion_servicio04'); ?>  
        </h4>
...
=================================-->
    <section class="seccion ubicacion">
      <div class="contenedor mapa">
        <iframe 
	        class="embebido" 
	        src="<?php the_field('seccion_mapa_url'); ?>" frameborder="0" style="border:0" allowfullscreen>
        </iframe>
        <h3 class="titulo">
          <?php the_field('seccion_mapa_titulo'); ?>
        </h3>
      </div>
    </section>
  </main><!--INICIO-->
